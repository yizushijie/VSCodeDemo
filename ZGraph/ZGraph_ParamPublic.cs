...
namespace Pengpai.UI
{
    public partial class ZGraph : UserControl
    {
        ...
        public Color m_coordinateLineColor
        {
            set
            {
                _coordinateLineColor = value;
            }
            get
            {
                return _coordinateLineColor;
            }
        }
        /// <summary>
        /// 坐标值颜色
        ...
        public Color m_coordinateStringColor
        {
            set
            {
                _coordinateStringColor = value;
            }
            get
            {
                return _coordinateStringColor;
            }
        }
        /// <summary>
        /// 坐标标题颜色
        ...
        public Color m_coordinateStringTitleColor
        {
            set
            {
                _coordinateStringTitleColor = value;
            }
            get
            {
                return _coordinateStringTitleColor;
            }
        }
        /// <summary>
        /// 网格线的透明度
        ...
        public int m_iLineShowColorAlpha
        {
            set
            {
                _iLineShowColorAlpha = value;
            }
            get
            {
                return _iLineShowColorAlpha;
            }
        }
        /// <summary>
        /// 网格线的颜色
        ...
        public Color m_iLineShowColor
        {
            set
            {
                _iLineShowColor = value;
            }
            get
            {
                return _iLineShowColor;
            }
        }
        /// <summary>
        /// 波形显示区域背景色
        ...
        public Color m_ControlButtonBackColor
        {
            set
            {
                ...
                buttonMoveModeXY.BackColor = ControlButtonBackColor;
                buttonShowNumModeXY.BackColor = ControlButtonBackColor;
                buttonCutMapModeXY.BackColor = ControlButtonBackColor;
                buttonClearModeXY.BackColor = ControlButtonBackColor;
            }
            get
            {
        ...
        public Color m_ControlButtonForeColorL
        {
            set
            {
                ControlButtonForeColorL = value;
            }
            get
            {
                return ControlButtonForeColorL;
            }
        }
        /// <summary>
        /// 工具栏按钮前景未选中颜色
        ...
        public Color m_ControlButtonForeColorH
        {
            set
            {
                ControlButtonForeColorH = value;
            }
            get
            {
                return ControlButtonForeColorH;
            }
        }
        /// <summary>
        /// 标签说明框背景颜色
        ...
        public Color m_BigXYBackColor
        {
            ...
            get
            {
                return BigXYBackColor;
            }
        }
        /// <summary>
        /// 坐标显示框背景颜色
        /// </summary>
        public Color m_ShowNumBackColor
        {
            set
            {
                ShowNumBackColor = value;
                labelShowNum.BackColor = ShowNumBackColor;
            }
            get
            {
                return ShowNumBackColor;
            }
        }
        /// <summary>
        /// 坐标显示框文字颜色
        /// </summary>
        public Color m_ShowNumForeClor
        {
            set
            {
                ShowNumForeClor = value;
                labelShowNum.ForeColor = ShowNumForeClor;
            }
            get
            {
                return ShowNumForeClor;
            }
        }
